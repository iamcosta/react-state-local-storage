...
exports.useLocalStoragePrototype = exports.useLocalStorage = void 0;
...
function useLocalStoragePrototype(key) {
    ...
    var _a = react_1.useState(function () {
        ...
        return null;
    }), stateItem = _a[0], setStateItem = _a[1];
    var handleSetItem = react_1.useCallback(function (item) {
    ...
    var handleClear = react_1.useCallback(function () {
        setStateItem(null);
        localStorage.clear();
    }, []);
    react_1.useEffect(function () {
...
exports.useLocalStoragePrototype = useLocalStoragePrototype;
